  ...
  <div
    ...
    <header class="lg:sticky lg:top-0 lg:flex lg:h-screen lg:flex-col lg:py-24">
      ...
      <ul class="mt-8 lg:mt-auto flex" aria-label="Social media">
        ...
        <li class="mr-5 text-xs">
          <a class="block hover:text-slate-200" href="https://instagram.com/lelluz_ph" target="_blank"
            rel="noreferrer"><span class="sr-only">Instagram</span><svg xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 1000 1000" fill="currentColor" class="h-6 w-6" aria-hidden="true">
              <path
        ...
        <li class="mr-5 text-xs">
          <a class="block hover:text-slate-200" href="https://twitter.com/_Lelluz" target="_blank" rel="noreferrer"><span
              class="sr-only">Twitter</span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 248 204"
        ...
        <li class="mr-5 text-xs">
          <a class="block hover:text-slate-200" href="https://www.linkedin.com/in/alessandro-lelli-dev/" target="_blank"
            rel="noreferrer"><span class="sr-only">LinkedIn</span><svg xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24" fill="currentColor" class="h-6 w-6" aria-hidden="true">
              <path
    ...
    <main class="lg:py-24">
        ...
        <ul v-for="experience in experiences" :key="experience.id" class="grouplist">
          <li class="mb-12">
            <div class="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
              <div class="absolute -inset-x-4 -inset-y-4 z-0 hidden transition motion-reduce:transition-none lg:-inset-x-6 lg:block lg:group-hover:bg-slate-800/50 lg:group-hover:drop-shadow-lg"></div>
              ...
              <div class="z-10 sm:col-span-6">
                <h3 class="font-medium leading-snug text-slate-200">
                  <div>
                    <a class="inline-flex items-baseline font-medium leading-tight text-slate-200 hover:text-sky-300 focus-visible:text-sky-300  group/link text-base" :href="experience.url" target="_blank" rel="noreferrer" aria-label="UI Engineer Co-op at Apple">
                ...
                <ul class="mt-2 flex flex-wrap" aria-label="Technologies used">
                  <li v-for="technology in experience.technologies" :key="technology.id" class="mr-1.5 mt-2">
                    <div class="flex items-center bg-sky-400/10 px-3 py-1 text-xs font-medium leading-5 text-sky-300">{{ technology.name }}</div>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <li class="mb-12">
            <div class="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
              ...
              <div class="z-10 sm:order-2 sm:col-span-6">
                <h3>
                  <a class="inline-flex items-baseline font-medium leading-tight text-slate-200 hover:text-sky-300 focus-visible:text-sky-300  group/link text-base" :href="project.url" target="_blank" rel="noreferrer" aria-label="Build a Spotify Connected App">
                    <span class="absolute -inset-x-4 -inset-y-2.5 hidden md:-inset-x-6 md:-inset-y-4 lg:block"></span>
              ...
              <img alt="" loading="lazy" width="200" height="48" decoding="async" data-nimg="1" class="border-2 border-slate-200/10 transition group-hover:border-slate-200/30 sm:order-1 sm:col-span-2 sm:translate-y-1 aspect-[98/61] object-cover" :src="`images/${project.imageName}`" style="color: transparent;">
            </div>
          </li>
        </ul>
      </section>
      ...
      <footer>
        <p class="max-w-md pb-16 text-sm text-slate-500 sm:pb-0">
          Design Inspired by
          <a href="https://brittanychiang.com/" class="font-medium text-slate-400 hover:text-sky-300 focus-visible:text-sky-300" target="_blank" rel="noreferrer">Brittany Chiang</a>
          website, but built with
          <a href="https://nuxt.com/" class="font-medium text-slate-400 hover:text-sky-300 focus-visible:text-sky-300" target="_blank" rel="noreferrer">Nuxt</a>
          from scratch using
          <a href="https://tailwindcss.com/" class="font-medium text-slate-400 hover:text-sky-300 focus-visible:text-sky-300" target="_blank" rel="noreferrer">Tailwind CSS</a>
          and deployed with
          <a href="https://www.netlify.com/" class="font-medium text-slate-400 hover:text-sky-300 focus-visible:text-sky-300" target="_blank" rel="noreferrer">Netlify</a>.
          All text is set in the
          <a href="https://rsms.me/inter/" class="font-medium text-slate-400 hover:text-sky-300 focus-visible:text-sky-300" target="_blank" rel="noreferrer">Inter</a>
          typeface.
        </p>
      </footer>
    </main>
